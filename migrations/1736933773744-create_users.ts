...
export class CreateUsers1736933773744 implements MigrationInterface {
  name = 'CreateUsers1736933773744';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_status_enum" AS ENUM('ACTIVE', 'PENDING')`,
    );
    await queryRunner.query(
