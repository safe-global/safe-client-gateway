...
// Global so the single FieldEncryptionService instance initialises at boot
// (wiring the TypeORM transformer bridge) and the encryption services are
// injectable wherever needed (e.g. repositories doing per-entity encryption).
@Global()
@Module({
