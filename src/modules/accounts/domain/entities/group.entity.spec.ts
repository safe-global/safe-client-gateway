import { groupBuilder } from '@/modules/accounts/domain/entities/__tests__/group.builder';
import { GroupSchema } from '@/modules/accounts/domain/entities/group.entity';
