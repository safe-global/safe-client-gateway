...
describe('RecipientAnalysisService', () => {
  ...
  describe('Input Validation', () => {
    describe('analyze method', () => {
      it.each([
        {
          description: 'empty chainId',
          args: { chainId: '', safeAddress: mockSafeAddress, transactions: [] },
        },
        {
          description: 'empty safeAddress',
          args: {
            chainId: mockChainId,
        ...
        {
          description: 'null transactions',
          args: {
            chainId: mockChainId,
            safeAddress: mockSafeAddress,
            transactions: null as unknown as Array<DecodedTransactionData>,
          },
        },
      ])(
        'should throw error when called with $description',
        async ({ args }) => {
          await expect(service.analyze(args)).rejects.toThrow(
    ...
    describe('analyzeInteractions method', () => {
      it.each([
        {
          description: 'empty chainId',
          args: {
        ...
        'should throw error when called with $description',
        async ({ args }) => {
          await expect(service.analyzeInteractions(args)).rejects.toThrow(
    ...
    describe('analyzeBridge method', () => {
      it.each([
        {
          description: 'empty chainId',
          args: { chainId: '', safeAddress: mockSafeAddress },
        },
        {
          description: 'empty safeAddress',
          args: { chainId: mockChainId, safeAddress: '' as Address },
        },
      ])(
        'should throw error when called with $description',
        async ({ args }) => {
          await expect(service.analyzeBridge(args)).rejects.toThrow(
