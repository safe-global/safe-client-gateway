...
> = {
  ...COMMON_SEVERITY_MAPPING,
  [RecipientStatus.NEW_RECIPIENT]: 'INFO',
  [RecipientStatus.RECURRING_RECIPIENT]: 'OK',
  [BridgeStatus.INCOMPATIBLE_SAFE]: 'CRITICAL',
  [BridgeStatus.MISSING_OWNERSHIP]: 'WARN',
  [BridgeStatus.UNSUPPORTED_NETWORK]: 'WARN',
  [BridgeStatus.DIFFERENT_SAFE_SETUP]: 'INFO',
  [RecipientStatus.LOW_ACTIVITY]: 'WARN',
};
...
> = {
  ...
  [RecipientStatus.RECURRING_RECIPIENT]: 'Recurring recipient',
  [BridgeStatus.INCOMPATIBLE_SAFE]: 'Incompatible Safe version',
  [BridgeStatus.MISSING_OWNERSHIP]: 'Missing ownership',
  [BridgeStatus.UNSUPPORTED_NETWORK]: 'Unsupported network',
  [BridgeStatus.DIFFERENT_SAFE_SETUP]: 'Different setup',
  [RecipientStatus.LOW_ACTIVITY]: 'Low activity recipient',
  [CommonStatus.FAILED]: 'Recipient analysis failed',
};
...
> = {
  ...
  [RecipientStatus.RECURRING_RECIPIENT]: ({ interactions = 0 } = {}) =>
  ...
  [RecipientStatus.LOW_ACTIVITY]: () => 'This address has few transactions.',
};
