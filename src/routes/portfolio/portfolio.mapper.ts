...
export function mapAppPosition(position: DomainAppPosition): AppPosition {
  return {
    key: position.key,
    type: position.type,
    name: position.name,
...
export function mapAppBalance(app: DomainAppBalance): AppBalance {
  return {
    appInfo: {
    ...
    positions: app.positions.map(mapAppPosition),
  };
}

export function mapToApiPortfolio(domainPortfolio: DomainPortfolio): Portfolio {
  return {
    ...
    tokenBalances: domainPortfolio.tokenBalances.map(mapTokenBalance),
    positionBalances: domainPortfolio.positionBalances.map(mapAppBalance),
  };
}
