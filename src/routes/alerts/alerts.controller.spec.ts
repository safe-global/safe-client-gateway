...
describe('Alerts (Unit)', () => {
  ...
  it('should notify of addOwnerWithThreshold calls', async () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(
      ...
      'addOwnerWithThreshold(0x3326c5D84bd462Ec1CadA0B5bBa9b2B85059FCba, 1) transaction added',
    );
  });

  it.todo('should notify of unknown calls');
